BS_implicit_AmPut_Gauss_Seidel = function(So,K,T,sigma,r,Smax,dS,dt){
  ...
  for (j in seq(N,1,-1)) {
    ...
    Price[seq(2,M), j] = Gauss_Seidel(A,z, K - veti*dS)
  }
...
implicit_AmPut_Gauss_Seidel = BS_implicit_AmPut_Gauss_Seidel(37,50,5/12,0.4,0.1,100,2,5/1200)